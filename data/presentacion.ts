...
export const productosPresentacion: Producto[] = [
  {
    ...
    variantes: [
      { id: "v1", nombre: "4 lb", precio: 45000, precioOriginal: 52000, sku: "RC-MED-4LB", stock: 15 },
      { id: "v2", nombre: "10 lb", precio: 95000, precioOriginal: 110000, sku: "RC-MED-10LB", stock: 8 },
      { id: "v3", nombre: "14 lb", precio: 125000, sku: "RC-MED-14LB", stock: 12 },
      { id: "v4", nombre: "25 lb", precio: 195000, sku: "RC-MED-25LB", stock: 5 },
    ],
  ...
  },
  {
    ...
    variantes: [
      { id: "v1", nombre: "3 kg", precio: 55000, sku: "PP-ADT-3KG", stock: 20 },
      { id: "v2", nombre: "7.5 kg", precio: 110000, precioOriginal: 125000, sku: "PP-ADT-75KG", stock: 10 },
      { id: "v3", nombre: "15 kg", precio: 185000, sku: "PP-ADT-15KG", stock: 7 },
    ],
  ...
  },
  {
    ...
    variantes: [
      { id: "v1", nombre: "400 g", precio: 28000, sku: "RC-CAT-400G", stock: 25 },
      { id: "v2", nombre: "2 kg", precio: 75000, precioOriginal: 88000, sku: "RC-CAT-2KG", stock: 14 },
      { id: "v3", nombre: "4 kg", precio: 130000, sku: "RC-CAT-4KG", stock: 8 },
    ],
    etiquetas: ["mas-vendido", "oferta"],
    activo: true,
    destacado: true,
  ...
  },
  {
    ...
    variantes: [
      { id: "v1", nombre: "1.5 kg", precio: 58000, sku: "PP-KIT-15KG", stock: 16 },
      { id: "v2", nombre: "3 kg", precio: 98000, precioOriginal: 110000, sku: "PP-KIT-3KG", stock: 11 },
    ],
    etiquetas: ["mas-vendido"],
    activo: true,
    destacado: true,
  ...
  },
  {
    ...
    variantes: [
      { id: "v1", nombre: "3.5 lb", precio: 48000, sku: "HS-ADT-35LB", stock: 18 },
      { id: "v2", nombre: "15 lb", precio: 135000, precioOriginal: 152000, sku: "HS-ADT-15LB", stock: 9 },
    ],
    etiquetas: ["oferta"],
    activo: true,
    destacado: false,
  ...
  },
  {
    ...
    variantes: [
      { id: "v1", nombre: "S (0–9 kg)", precio: 32000, sku: "KONG-S", stock: 20 },
      { id: "v2", nombre: "M (9–16 kg)", precio: 38000, sku: "KONG-M", stock: 15 },
      { id: "v3", nombre: "L (16–29 kg)", precio: 48000, precioOriginal: 55000, sku: "KONG-L", stock: 10 },
    ],
  ...
  },
  {
    ...
    variantes: [{ id: "v1", nombre: "3 L", precio: 89000, precioOriginal: 105000, sku: "CATIT-BEB-3L", stock: 7 }],
    etiquetas: ["oferta"],
    activo: true,
    destacado: true,
    masVendido: false,
  },
  {
    ...
    variantes: [
      { id: "v1", nombre: "XS", precio: 45000, sku: "ZD-COL-XS", stock: 8 },
      { id: "v2", nombre: "S", precio: 50000, sku: "ZD-COL-S", stock: 12 },
      { id: "v3", nombre: "M", precio: 55000, sku: "ZD-COL-M", stock: 10 },
      { id: "v4", nombre: "L", precio: 60000, sku: "ZD-COL-L", stock: 6 },
    ],
    etiquetas: ["nuevo"],
    activo: true,
    destacado: false,
